...
class s2looking_dataset(Dataset):
    ...
    def _load_dataset(self):
        ...
        for f in fids:
            img1 = os.path.join(self.dataset_url, 'Image1', f)
            assert os.path.isfile(img1), img1
            img2 = os.path.join(self.dataset_url, 'Image2', f)
...
def get_train_transform():
    return A.Compose(
        [
            ...
            A.RandomResizedCrop(512, 512, scale=(0.9, 2.0), ratio=(0.75, 1.333), always_apply=True),
